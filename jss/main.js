/*Text in JS*/
/*let matn = "Assalomu alaykum,do'stlarim!";*/
/*console.log(matn,length)*/
/*let matn = "sen gapir men esa sen bilan yozib boraman!"
let birinchiSenIdeksi = matn.indexOf("sen")
console.log(matn.indexOf("sen",birinchiSenIdeksi+1))*/
/*let matn = "Salom hammaga! salom berdim hammaga.";*/
/*console.log(matn.replace(/salom|hammmaga|berdim/gi,'alik'))*/
/*
let yandiMatn =matn.replace(/salom|hammmaga|berdim/gi,function (soz){
...
console.log(yandiMatn)*/

/*Ma'lumotlar kiritish: push va pop;shift va unshrift*/
